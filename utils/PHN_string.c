...
const int	arr_baud[7] = {1200, 4800, 9600, 19200, 38400, 57200, 115200};
...
{
	uint8_t	gap[10] = {1,2,4,8,12,24,36,120,180,240};
	
	system_conf_t *p_cfg = (system_conf_t *)p;
	switch(aux)
	{
		case es_rcd_t_s:
			p_cfg->set_gap_level = Operate_in_range(p_cfg->set_gap_level, op, val, 0, 9);
			p_cfg->record_gap_s = gap[p_cfg->set_gap_level];
